...
for row in csv_reader:
    ...
    cpcli, villecli, codcde, datcde, timbrecli, timbrecde, Nbcolis, qte, points = (
        row[4],
        row[5],
        row[6],
        row[7],
    ...
    # Remplacez les champs vides ou les NULL par 0 ou ""
    ...
    if annee >= 2006 and annee <= 2016:
        print(
            "%s;%s;%s;%s;%s;%s;%s;%s"
            % (cpcli, codcde, timbrecde, Nbcolis, qte, points, timbrecli, villecli)
        )
